...
public class AdminController {
    ...
    public AdminController(StudentRepo studentRepo, ModelMapper modelMapper,MarkRepo markRepo) {
...
//        convert student form to student entity
        ...
        markRepo.saveAll(student.getMarks());
